<template>
	<div v-if="game">
		...
		<div>
			<b-form v-if="lista.name !== game.game_name" @submit="add_plist()">
				<b-card
					class="mx-auto"
					style="max-width: 900px; -webkit-box-shadow: none; -moz-box-shadow: none;box-shadow: none; "
				>
			...
			<b-form v-if="lista.name == game.game_name" @submit="del_plist()">
				<b-card
					class="mx-auto"
					style="max-width: 900px; -webkit-box-shadow: none; -moz-box-shadow: none;box-shadow: none; "
				>
					...
					<div style="float:left; ">
						<button
							class="add"
							type="submit"
							style="background-color:#7d7d7d; color:white;"
						>
...
export default {
	...
	methods: {
		...
		async add_plist() {
			...
			if (this.lista.name == this.game.game_name) {
		...
		del_plist() {
			...
			Service.post("/Playlist/delete", plist).then((result) => {
				console.log(result);
			});
		},
		async add_comment() {
