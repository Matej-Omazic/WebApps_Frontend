<template>
    ...
    <div>
        <b-card class="mx-auto" style="max-width: 900px; -webkit-box-shadow: none; -moz-box-shadow: none;box-shadow: none; ">
            ...
            <div style="float:left; "><mdb-btn color="primary" style="max-width:400px;">Add to playlist</mdb-btn></div>
        </b-card>
    </div>
      <!-- Photos -->
   ...
   <!-- Details -->
    ...
    <!-- Time to beat -->    
        <div>
                ...
                <div style="max-widith:900px;"><hr style="clear: none; position: relative; "></div>
        </div>
    <!-- Storyline -->    
        <div>
                <b-card class=" mx-auto" style="max-width: 900px; -webkit-box-shadow: none; -moz-box-shadow: none;box-shadow: none; ">
